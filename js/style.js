            ...
            if(buttonClass[j]==="red"||buttonClass[j]==="yellow"||buttonClass[j]==="blue"){
                ...
                switch(user){
                    case "red": document.querySelector(".user button").classList.remove("yellow","blue");
                                ...
                                document.querySelector(".user button img").src="./image/icon-rock.svg";
                                ...
                                document.querySelector(".play-div .player img").src="./image/icon-rock.svg";
                    break;
                    ...
                    case "yellow":document.querySelector(".user button").classList.remove("red","blue");
                                ...
                                document.querySelector(".user button img").src="./image/icon-scissors.svg";
                                ...
                                document.querySelector(".play-div .player img").src="./image/icon-scissors.svg";
                    break;
                    ...
                    case "blue":document.querySelector(".user button").classList.remove("yellow","red");
                                ...
                                document.querySelector(".user button img").src="./image/icon-paper.svg";
                                ...
                                document.querySelector(".play-div .player img").src="./image/icon-paper.svg";
                    break;
                }
            }
        }
        ...
        const computerColour = buttonOptions[choice];
            switch(computerColour){
                case "red": setTimeout(function(){
                            ...
                            document.querySelector(".comp button img").src="./image/icon-rock.svg";},500);
                            document.querySelector(".play-div .bot").classList.add("yellow","blue");
                            document.querySelector(".play-div .bot").classList.add("red");
                            document.querySelector(".play-div .bot img").src="./image/icon-rock.svg";
                break;
                ...
                case "yellow":setTimeout(function(){
                            ...
                            document.querySelector(".comp button img").src="./image/icon-scissors.svg";},500);
                            document.querySelector(".play-div .bot").classList.remove("red","blue");
                            document.querySelector(".play-div .bot").classList.add("yellow");
                            document.querySelector(".play-div .bot img").src="./image/icon-scissors.svg";
                break;
                ...
                case "blue":setTimeout(function(){
                            ...
                            document.querySelector(".comp button img").src="./image/icon-paper.svg";},500);
                            document.querySelector(".play-div .bot").classList.remove("yellow","red");
                            document.querySelector(".play-div .bot").classList.add("blue");
                            document.querySelector(".play-div .bot img").src="./image/icon-paper.svg";
            break;
        }
